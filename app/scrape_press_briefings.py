...
def main():
    usage = "%prog\n" \
            "Scrape press briefings from the American Presidency Project"
    parser = OptionParser(usage=usage)
    parser.add_option('--outdir', type=str, default='data/app/press_briefings/',
    ...
    initial_target = '/documents/app-categories/pressmedia/press-briefings'
