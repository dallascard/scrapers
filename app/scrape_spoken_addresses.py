...
def main():
    usage = "%prog\n" \
            "Scrape spoken addresses and remarks from the American Presidency Project"
    parser = OptionParser(usage=usage)
    parser.add_option('--outdir', type=str, default='data/app/spoken_addresses/',
                      help='Output directory): default=%default')
    parser.add_option('--pages', type=int, default=645,
    ...
    for page in range(pages):
        if page == 0:
            ...
            url = 'https://www.presidency.ucsb.edu/documents/app-categories/presidential/spoken-addresses-and-remarks?page=' + str(page)
    ...
    with open(os.path.join(outdir, 'spoken_addresses.all.jsonlist'), 'w') as fo:
