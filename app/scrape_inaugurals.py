...
def main():
    ...
    parser.add_option('--outdir', type=str, default='data/app/inaugurals/',
    ...
    initial_target = '/documents/app-categories/spoken-addresses-and-remarks/presidential/inaugural-addresses'
