...
def main():
    ...
    parser.add_option('--outdir', type=str, default='data/app/inaugural/',
                      help='Output directory): default=%default')
    parser.add_option('--pages', type=int, default=7,
    ...
    for page in range(pages):
        if page == 0:
            ...
            url = 'https://www.presidency.ucsb.edu/documents/app-categories/spoken-addresses-and-remarks/presidential/inaugural-addresses?page=' + str(page)
    ...
    print("Saving {:d} inaugurals".format(len(outlines)))
    with open(os.path.join(outdir, 'inaugurals.all.jsonlist'), 'w') as fo:
