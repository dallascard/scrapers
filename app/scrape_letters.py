...
def main():
    usage = "%prog\n" \
            "Scrape letters from the American Presidency Project"
    parser = OptionParser(usage=usage)
    parser.add_option('--outdir', type=str, default='data/app/letters/',
    ...
    initial_target = '/documents/app-categories/presidential/letters'
