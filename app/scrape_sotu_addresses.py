...
def main():
    usage = "%prog\n" \
            "Scrape state of the union addesses (spoken) from the American Presidency Project"
    ...
    initial_target = '/documents/app-categories/spoken-addresses-and-remarks/presidential/state-the-union-addresses'
