...
def main():
    ...
    while not done:
        ...
        url = 'https://archive.org/download/Life-{:s}-Vol-{:d}-No-{:d}/Life%20-%20{:s}%20-%20v{:s}%20n{:s}_text.pdf'.format(date_str, volume, number, date_str, str(volume).zfill(2), str(number).zfill(2))
